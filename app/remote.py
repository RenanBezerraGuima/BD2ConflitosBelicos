...
def conexaoBD():
    ...
    try:
        ...
        conexao = psycopg.connect("postgresql://neondb_owner:npg_tR8DcpdN1rAI@ep-bitter-tooth-a8mynly3-pooler.eastus2.azure.neon.tech/neondb?sslmode=require")
        return conexao
    except psycopg.OperationalError as e:
        st.error(f"Erro ao conectar ao banco de dados: {e}")
        return None

def resetarBancoDeDados():
